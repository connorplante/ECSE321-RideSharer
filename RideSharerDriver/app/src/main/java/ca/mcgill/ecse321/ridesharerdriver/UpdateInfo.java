...
public class UpdateInfo extends AppCompatActivity {
    ...
    public static final String FIRSTNAME = "ca.mcgill.ecse321.ridesharerdriver.firstName";
    public static final String LASTNAME = "ca.mcgill.ecse321.ridesharerdriver.lastName";
    public static final String EMAIL  = "ca.mcgill.ecse321.ridesharerdriver.email";
    public static final String PHONE = "ca.mcgill.ecse321.ridesharerdriver.phone";
