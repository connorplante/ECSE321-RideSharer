...
public PassengerTrip confirmBook(@RequestParam(value="tripID")int tripID,@RequestParam(value="username")String username,@RequestParam(value="pointA")String pointA,@RequestParam(value="pointB")String pointB) {
...
int startId=0;
 ...
 for(int i=0; i< allLegs.size(); i++) {
     System.out.println(allLegs.get(i).getStart());
